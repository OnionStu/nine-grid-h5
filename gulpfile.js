...
gulp.task('rjs', ['copy'], function(cb) { //rjs合并模块
  /* return gulp.src('./dist/js/**.js')
     .pipe(amdOptimize("./dist/js/sui-requirejs", {
       // configFile: "build.js",
       paths: {
         zepto: './dist/lib/vendor/sui/zepto',
         sm: './dist/lib/vendor/sui/sm',
         smExtend: './dist/lib/vendor/sui/sm-extend',
         underscore: './dist/lib/vendor/underscore/underscore',
         view: './dist/lib/js/view',
         indexModule: './dist/js/index'
       },
       shim: {
         'zepto': {
           exports: '$'
     ...
     .pipe(concat("sui-requirejs.js")) //合并  
