...
+function ($) {
 ...
 //    var back = this.stack.getItem("back") || "[]";
	// var forward = this.stack.getItem("forward") || "[]";   

	// this.stack.setItem("back", back);  //返回栈, {url, pageid, stateid}
 //    this.stack.setItem("forward", forward);  //前进栈, {url, pageid, stateid} 
  ...
  Router.prototype.loadPage = function(url, stateId) {
    ...
    this.getPage(url, function(page) {
     ...
     /* var pageid = currentPageList[0].id;
      this.pushBack({
        url: url,
        pageid: "#"+ pageid,
...
*/
      ...
      this.animatePages(currentPageList, page, (currentStateId > stateId));	
  ...
  //后退
  Router.prototype._back = function(state) {
    // var h = this.popBack();
    // var h = state;
    // this.loadPage(h.url, h.id);
    /*var currentPage = this.getCurrentPage();
  ...
  //前进
  Router.prototype._forward = function(state) {
  ...
  Router.prototype.onpopstate = function(d) {
   ...
   /* if(forward) this._forward(state);
    else this._back(state);*/
  }
  ...
  Router.prototype.genStateID = function() {
    var id = parseInt(this.state.getItem("stateid") || 1) + 1;
